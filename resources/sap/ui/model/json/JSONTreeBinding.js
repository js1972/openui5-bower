...
sap.ui.model.json.JSONTreeBinding.prototype.getNodeContexts=function(c){var C=c.getPath();if(!jQuery.sap.endsWith(C,"/")){C=C+"/"}if(!jQuery.sap.startsWith(C,"/")){C="/"+C}var a=[],t=this,n=this.oModel._getObject(C),o,A=this.mParameters&&this.mParameters.arrayNames,b;if(A&&jQuery.isArray(A)){jQuery.each(A,function(i,s){b=n[s];if(b){jQuery.each(b,function(S,d){t._saveSubContext(d,a,C,s+"/"+S)})}})}else{if(n){jQuery.sap.each(n,function(N,o){if(jQuery.isArray(o)){jQuery.each(o,function(s,S){t._saveSubContext(S,a,C,N+"/"+s)})}else if(o&&typeof o=="object"){t._saveSubContext(o,a,C,N)}})}}return a};
